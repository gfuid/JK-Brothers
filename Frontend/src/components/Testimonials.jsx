  ...
  const testimonials = [
    {
      ...
      quote: "The quality of blankets and bedsheets we received is outstanding. The thread count, weave consistency, and rich designs have made ZK BROTHERS our exclusive handloom supplier.",
      rating: 5,
    ...
    },
    {
      ...
      location: 'Dubai, UAE',
      quote: "We have been importing garments and carpets from ZK BROTHERS for over 5 years now. Their commitment to international delivery timelines and export packaging standards is exemplary.",
      rating: 5,
